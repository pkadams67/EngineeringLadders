...
This framework allows software engineering managers to have meaningful conversations with their direct reports about the expectations of each position and how to plan for the next level in their career ladder.

Although the framework uses standard roles and levels in the US tech industry, every company is different. Please use the information provided as a baseline and feel free to adjust it to your needs.
...
* [**Developer**](Developer.md): a role also known as a programmer or software engineer that requires a deep level of technical expertise
* [**Tech Lead**](TechLead.md): a role also known as dev lead, is the owner of the system and requires a unique balance between hands-on development, architecture knowledge, and production support
* [**Technical Program Manager**](TechnicalProgramManager.md): a role responsible for coordinating and driving to completion initiatives that span multiple teams
* [**Engineering Manager**](EngineeringManager.md): a role also known as a dev manager, is responsible for the consistent delivery, career growth, and level of happiness of the team
...
Each axis has 5 different levels of performance. It is important to highlight that every level includes the previous one(s). For example, someone who *evangelizes* technology, *specializes* and *adopts* it as well.

Keep reading to understand each level better.
...
2. **Specializes**: is the go-to person for one or more technologies and takes the initiative to learn new ones
3. **Evangelizes**: researches, creates proofs of concept, and introduces new technologies to the team
4. **Masters**: has profound knowledge about the whole technology stack of the system
...
3. **Multiple Teams**: makes an impact not only on their team but also on other teams
4. **Company**: makes an impact on the whole tech organization
5. **Community**: makes an impact on the tech community

# FAQs

**What if some of the people need to meet all the points?**

That is very normal. People are usually more robust in some areas and weaker in others. The framework should not be used as a checklist to promote people but as guidance to have meaningful career conversations.

**What if my organization's career ladder is different?**

Since the framework is open source, you can adapt it to your organization. You can define your levels using the [chart template](charts/template.png).
...
Specific behavior examples require knowledge about how the team works, the system architecture, and its technology stack. It is recommended to allow each team to define their criteria.

**Why does the framework stop at level 7?**

Levels 8 and above vary drastically from company to company. Organizations of different sizes tend to assign a diverse scope to positions so high in their structure.

**Do you have any additional resources about the topic?**

* [The Manager's Path](http://shop.oreilly.com/product/0636920056843.do): Camille Fournier does an excellent job describing the expectations and challenges of many engineering positions. Also, she provides sound advice about writing a career ladder in chapter 9.
